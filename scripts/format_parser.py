...
for filename in glob.iglob('/Users/Amine/Desktop/Imperial College - CS/Spring term/Msc Project/packet_logs_250/*'):
    ...
    filename2 = '_'.join(filename2[1:])
    print(filename2)

    #create processed file
    filepath = os.path.join('/Users/Amine/Desktop/Imperial College - CS/Spring term/Msc Project/packet_logs_formated_250/', filename2)
